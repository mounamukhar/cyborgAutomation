...
//	public void setUpExecution() throws Exception
//	{
//		if(!executionSetupComplete) {
//			System.out.println("EXECUTE ONLY ONCE");
//			setUpBeforeTest();
//			readRunProp();			
//			executionSetupComplete = true;
//		}
//	}
...
//	public void executionCleanup() throws Exception
//	{
//		tearDownSuite();
//	}
...
//            log.error("Exception occured while setting up the test ", e);
    ...
    private void readUserProp() throws IOException {
        ...
        propertyDealer propHandler = new propertyDealer("execution.properties");
...
//        resultReporter.addNewTestSuite(this.getClass().getSimpleName());
     ...
     */
//    @BeforeMethod
    public final void setTestContext(final Scenario scenario) {
        setTestCaseFailedStatus(false);
        //propertyDealer propHandler = new propertyDealer(propertiesLocation);
...
//    }
    ...
    public static final void setRobot(final Robot robotObj) {
        cucumberTNGhelper.robot = robotObj;
    }
    ...
    public static final void setProp(final Properties propObj) {
    	cucumberTNGhelper.prop = propObj;
    }
    ...
    public static final void setPropertiesLocation(
    	...
    	cucumberTNGhelper.propertiesLocation = propertiesLocationString;
    }
    ...
    public static final void setExecProps(final Properties execPropsObj) {
    	cucumberTNGhelper.execProps = execPropsObj;
    }
    ...
    public static final void setRetryCount(final int retryCountInt) {
        cucumberTNGhelper.retryCount = retryCountInt;
    }
